...
public class adabter_user_bookig_tourguid extends RecyclerView.Adapter<HHVVV>
{
    ...
    FirebaseAuth fauth;
    public adabter_user_bookig_tourguid(Context context, List<data_user_booking> dataLList) {
    ...
    @NonNull
    @Override
    public HHVVV onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull HHVVV holder, int position) {

        holder.RView_typeB1.setText(dataLList.get(position).getBooking_Type());
        holder.RView_booking_name2.setText(dataLList.get(position).getBooking_name());
                        ...
                        .setPositiveButton(" Yes ", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                fstore.collection("Booking").document(fauth.getCurrentUser().getUid())
                                        .collection("TOUR GUID BOOKING LIST")
...
class HHVVV extends RecyclerView.ViewHolder {

    TextView RView_typeB1,RView_booking_name2, RView_idB, RView_nameB, RView_phoneB,RView_priseB,RView_dayyB,RView_totallB,RView_quantity;
    CardView recyclerview_bookingcard;

    public HHVVV(@NonNull View item_View) {
        super(item_View);

        recyclerview_bookingcard = item_View.findViewById(R.id.recyclerview_bookingcard);

        RView_typeB1 = item_View.findViewById(R.id.RView_typeB);
        RView_booking_name2 = item_View.findViewById(R.id.RView_booking_name);
