...
public class adapter_U_TA extends RecyclerView.Adapter<v> {
    private Context context_ta;
    private List<data_ta> dataLList_ta;

    public adapter_U_TA(Context context_ta, List<data_ta> dataLList_ta) {
    ...
    public void onBindViewHolder(@NonNull v holder, int position) {
        ...
        holder.RView_type.setText(dataLList_ta.get(position).getType());
        ...
        holder.recyclerview_acard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context_ta, u_ta.class);
...

{
    ...
    TextView RView_IDA,RView_NameA,RView_LocationA,RView_informationA,RView_instructionA,RView_priceA,RView_dayA,RView_type;
    CardView recyclerview_acard;

    public v(@NonNull View item_View) {
        super(item_View);
