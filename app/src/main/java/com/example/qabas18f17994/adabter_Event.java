...
public class adabter_Event extends RecyclerView.Adapter<EViewHolder>{


    private Context context;
    private List<data_events> dataLList;

    public adabter_Event(Context context, List<data_events> dataLList) {
    ...
    public void onBindViewHolder(@NonNull EViewHolder holder, int position) {
        ...
        holder.recyclerview_Ecard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, event_ditails.class);
...
class EViewHolder extends RecyclerView.ViewHolder
{
    ...
    public EViewHolder(@NonNull View item_View) {
        super(item_View);
